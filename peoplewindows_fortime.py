...
point = ['忠孝敦化', '市政府', '港墘', '松江南京', '台北車站', '板橋', '科技大樓', '石牌']
site = ['忠孝敦化', '市政府', '港墘', '松江南京', '台北車站', '板橋', '科技大樓', '石牌']
dataname = [['zhongciao_work_in', 'zhongciao_week_in'], ['cityhall_work_in', 'cityhall_week_in'], ['ganchain_work_in', 'ganchain_week_in'], ['songgan_work_in', 'songgan_week_in'], ['taipei_work_in', 'taipei_week_in'], ['banqiao_work_in', 'banqiao_week_in'], ['techbuil_work_in', 'techbuil_week_in'], ['xiban_work_in', 'xiban_week_in']]
