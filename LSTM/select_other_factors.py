...
for t in traindata:
    for th in Threshold_Folder:
        ...
        first_time_columns.to_csv('./data/other_data/' + t + '_' + th + '_' + str(select_hour[c][0]) + '_other.csv')
        second_time_columns.to_csv('./data/other_data/' + t + '_' + th + '_' + str(select_hour[c][1]) + '_other.csv')
        third_time_columns.to_csv('./data/other_data/' + t + '_' + th + '_' + str(select_hour[c][2]) + '_other.csv')
